...
var contractAddress = "0x7Bf3584168AD4F1342C3Be4019f854D1bb19AE91";
var prev_account;
var ref = 0;
...
function copyRef() {
  ...
  try {
    ...
    document
      .querySelector(".widget-4 .copy-ref .fas")
...
function refreshData() {
  ...
  if (
    web3["eth"]["accounts"][0] &&
    web3["eth"]["accounts"][0] != prev_account
  ) {
  ...
  web3["eth"]["call"](
    ...
    function (_0x92e6x12, _0x92e6x13) {
      if (!_0x92e6x12) {
        ...
        newDividendsArr = parseDataArr(
          _0x92e6x13,
          9 + 1 + currentDividendsArr["length"]
        );
        $("#referrerEarnings")["html"](parseData(_0x92e6x13, 0));
        $("#availableReferrerEarnings")["html"](
          weiToDisplay(parseData(_0x92e6x13, 1))
        );
        ...
        $("#withdrawable")["html"](
          Number(_0x92e6x36 + weiToDisplay(parseData(_0x92e6x13, 1)))[
            "toFixed"
          ](6)
        );
    ...
    function (_0x92e6x12, _0x92e6x13) {
      if (!_0x92e6x12) {
        ...
        for (i = 0; i < planIds["length"]; i++) {
          if (lang == "rus") {
            _0x92e6x39 +=
              "<p class='myInv'><b><span class='blue'>" +
              weiToDisplay(investments[i]) +
              " BNB</span> - <span style='color:#db2b61'>" +
              plans_rus[planIds[i]] +
              "</span></b> <span>" +
              parseTimestamp(Number(investmentDates[i])) +
              "</span>";
            _0x92e6x39 +=
              "<br>\u0412\u044B\u043F\u043B\u0430\u0447\u0435\u043D\u043E <b>" +
              Number(weiToDisplay(currentDividends[i]))["toFixed"](4) +
              "</b> BNB | <span>\u0414\u043B\u044F \u0432\u044B\u0432\u043E\u0434\u0430 <b>" +
              Number(weiToDisplay(_0x92e6x38[i]))["toFixed"](4) +
              "</b> BNB</span></p><br><br>";
          } else {
            if (lang == "cn") {
              _0x92e6x39 +=
